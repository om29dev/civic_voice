...
class FormFillerService {
  ...
  static final Map<String, GovernmentFormDef> _forms = {
    ...
    'passport': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Full Name', labelHindi: 'पूरा नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Mother\'s Name', labelHindi: 'माता का नाम', dataKey: 'mother_name', isRequired: false),
        FormFieldDef(id: 'f6', label: 'Spouse Name', labelHindi: 'जीवनसाथी का नाम', dataKey: 'spouse_name', isRequired: false),
        FormFieldDef(id: 'f7', label: 'Address Line 1', labelHindi: 'पता पंक्ति 1', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f8', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f9', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f10', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', validationPattern: r'^\d{6}$', isRequired: false),
        FormFieldDef(id: 'f11', label: 'Mobile Number', labelHindi: 'मोबाइल नंबर', dataKey: 'mobile_number', validationPattern: r'^\d{10}$', isRequired: false),
    ...
    'pan_card': const GovernmentFormDef(
      ...
      fields: [
        ...
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f6', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f7', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'voter_id': const GovernmentFormDef(
      ...
      fields: [
        ...
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father/Husband Name', labelHindi: 'पिता/पति का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f6', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f7', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f8', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'aadhaar_card': const GovernmentFormDef(
      ...
      fields: [
        ...
        FormFieldDef(id: 'f3', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f4', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f5', label: 'Address Line 1', labelHindi: 'पता पंक्ति 1', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f6', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f7', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f8', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'driving_license': const GovernmentFormDef(
      ...
      fields: [
        ...
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Blood Group', labelHindi: 'रक्त समूह', dataKey: 'blood_group', fieldType: 'dropdown', options: ['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'], isRequired: false),
        FormFieldDef(id: 'f6', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f7', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f8', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f9', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f10', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'ration_card': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Head of Family', labelHindi: 'परिवार का मुखिया', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f4', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f5', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        ...
        FormFieldDef(id: 'f11', label: 'Annual Income', labelHindi: 'वार्षिक आय', dataKey: 'annual_income', isRequired: false),
        FormFieldDef(id: 'f12', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'pm_kisan': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Farmer Name', labelHindi: 'किसान का नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Father Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Category', labelHindi: 'श्रेणी', dataKey: 'caste', isRequired: false),
        FormFieldDef(id: 'f5', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f6', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f7', label: 'Village', labelHindi: 'गाँव', dataKey: 'village', isRequired: false),
        FormFieldDef(id: 'f8', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Aadhaar Number', labelHindi: 'आधार नंबर', dataKey: 'aadhaar_number'),
        FormFieldDef(id: 'f10', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f11', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
        FormFieldDef(id: 'f12', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
      ],
    ),
    ...
    'ayushman_bharat': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Head of Family', labelHindi: 'परिवार मुखिया', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f5', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f6', label: 'Aadhaar Number', labelHindi: 'आधार नंबर', dataKey: 'aadhaar_number'),
        FormFieldDef(id: 'f7', label: 'Ration Card', labelHindi: 'राशन कार्ड', dataKey: 'ration_card_number', isRequired: false),
        FormFieldDef(id: 'f8', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
      ],
    ),
    ...
    'senior_citizen_pension': const GovernmentFormDef(
      ...
      requiredDocuments: [DocumentType.aadhaar],
      optionalDocuments: [DocumentType.bankPassbook, DocumentType.incomeCertificate],
      ...
      fields: [
        ...
        FormFieldDef(id: 'f10', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f11', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
        FormFieldDef(id: 'f12', label: 'Annual Income', labelHindi: 'वार्षिक आय', dataKey: 'annual_income', isRequired: false),
        FormFieldDef(id: 'f13', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
      ],
    ),
    ...
    'income_tax': const GovernmentFormDef(
      ...
      fields: [
        ...
        FormFieldDef(id: 'f7', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
        FormFieldDef(id: 'f8', label: 'Email', labelHindi: 'ईमेल', dataKey: 'email_address', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f10', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
        FormFieldDef(id: 'f11', label: 'Aadhaar Number', labelHindi: 'आधार नंबर', dataKey: 'aadhaar_number'),
      ],
    ),
    ...
    'birth_certificate': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Child\'s Name', labelHindi: 'बच्चे का नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Mother\'s Name', labelHindi: 'माता का नाम', dataKey: 'mother_name', isRequired: false),
    ...
    'national_scholarship': const GovernmentFormDef(
      ...
      requiredDocuments: [DocumentType.aadhaar],
      optionalDocuments: [DocumentType.incomeCertificate, DocumentType.bankPassbook],
      submitInstructions: 'Apply at scholarships.gov.in. Verify with institution.',
      fields: [
        FormFieldDef(id: 'f1', label: 'Student Name', labelHindi: 'छात्र का नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Gender', labelHindi: 'लिंग', dataKey: 'gender', fieldType: 'dropdown', options: ['Male', 'Female', 'Other'], isRequired: false),
        FormFieldDef(id: 'f4', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        FormFieldDef(id: 'f5', label: 'Category', labelHindi: 'श्रेणी', dataKey: 'caste', isRequired: false),
        FormFieldDef(id: 'f6', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f7', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f8', label: 'Annual Income', labelHindi: 'वार्षिक आय', dataKey: 'annual_income', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Aadhaar Number', labelHindi: 'आधार नंबर', dataKey: 'aadhaar_number'),
        FormFieldDef(id: 'f10', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f11', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
        FormFieldDef(id: 'f12', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'gst_registration': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Legal Name', labelHindi: 'कानूनी नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'PAN Number', labelHindi: 'पैन नंबर', dataKey: 'pan_number'),
        FormFieldDef(id: 'f3', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f4', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f5', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f6', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f7', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
    ...
    'epfo_account': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Full Name', labelHindi: 'पूरा नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Date of Birth', labelHindi: 'जन्म तिथि', dataKey: 'date_of_birth', fieldType: 'date', isRequired: false),
        FormFieldDef(id: 'f3', label: 'Father\'s Name', labelHindi: 'पिता का नाम', dataKey: 'father_name', isRequired: false),
        ...
        FormFieldDef(id: 'f6', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f7', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
        FormFieldDef(id: 'f8', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
      ],
    ),
    ...
    'msme_registration': const GovernmentFormDef(
      ...
      fields: [
        FormFieldDef(id: 'f1', label: 'Owner Name', labelHindi: 'मालिक का नाम', dataKey: 'full_name', isRequired: false),
        FormFieldDef(id: 'f2', label: 'Aadhaar Number', labelHindi: 'आधार नंबर', dataKey: 'aadhaar_number'),
        FormFieldDef(id: 'f3', label: 'PAN Number', labelHindi: 'पैन नंबर', dataKey: 'pan_number'),
        FormFieldDef(id: 'f4', label: 'Address', labelHindi: 'पता', dataKey: 'address_line1', isRequired: false),
        FormFieldDef(id: 'f5', label: 'State', labelHindi: 'राज्य', dataKey: 'state', fieldType: 'dropdown', options: _indianStates, isRequired: false),
        FormFieldDef(id: 'f6', label: 'District', labelHindi: 'जिला', dataKey: 'district', isRequired: false),
        FormFieldDef(id: 'f7', label: 'PIN Code', labelHindi: 'पिन कोड', dataKey: 'pincode', isRequired: false),
        FormFieldDef(id: 'f8', label: 'Mobile', labelHindi: 'मोबाइल', dataKey: 'mobile_number', isRequired: false),
        FormFieldDef(id: 'f9', label: 'Email', labelHindi: 'ईमेल', dataKey: 'email_address', isRequired: false),
        FormFieldDef(id: 'f10', label: 'Bank Account', labelHindi: 'बैंक खाता', dataKey: 'account_number', isRequired: false),
        FormFieldDef(id: 'f11', label: 'IFSC Code', labelHindi: 'IFSC कोड', dataKey: 'ifsc_code', isRequired: false),
      ],
    ),
