                          ...
                          child: GlassCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Text(guide.category, style: GoogleFonts.spaceMono(color: AppColors.gold, fontSize: 12)),
                                    ),
                                    const Icon(Icons.bookmark_added, color: AppColors.emeraldLight, size: 20),
                                  ],
                                ),
                                ...
                                Text('Steps to Follow', style: GoogleFonts.poppins(color: AppColors.textPrimary, fontWeight: FontWeight.w600)),
                                const SizedBox(height: 12),
                                ...guide.steps.asMap().entries.map((step) {
                                  return Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CircleAvatar(
                                          ...
                                          child: Text('${step.key + 1}', style: GoogleFonts.spaceMono(fontSize: 10, color: AppColors.accentBlue)),
                                        ),
                                        const SizedBox(width: 12),
                                        Expanded(child: Text(step.value, style: GoogleFonts.inter(color: AppColors.textSecondary, height: 1.4))),
                                      ],
                                    ),
                                  );
                                }),
                                ...
                                Text('Required Documents', style: GoogleFonts.poppins(color: AppColors.textPrimary, fontWeight: FontWeight.w600)),
                                const SizedBox(height: 8),
                                ...guide.requiredDocuments.map((doc) => Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 4),
                                  child: Row(
                                    children: [
                                      const Icon(Icons.check, color: AppColors.emeraldLight, size: 16),
                                      const SizedBox(width: 8),
                                      Text(doc, style: GoogleFonts.inter(color: AppColors.textSecondary)),
                                    ],
                                  ),
                                )),
                                ...
                                if (guide.tip.isNotEmpty) ...[
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        const Icon(Icons.lightbulb, color: AppColors.saffron, size: 20),
                                        const SizedBox(width: 12),
                                        Expanded(
                                          child: Text(
                                            guide.tip,
                                            style: GoogleFonts.inter(color: AppColors.saffron, fontSize: 13, fontStyle: FontStyle.italic),
                                          ),
                                        )
                                      ],
                                    ),
