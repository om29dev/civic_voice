...
class _SchemeDiscoveryScreenState extends State<SchemeDiscoveryScreen> {
  ...
  void _voiceSearch(SchemeDiscoveryProvider provider) {
    // Future AWS Integration Point: Voice capture to Amazon Transcribe, then pass transcript to search
    // Mocking voice behavior:
    _searchController.text = 'Health';
    provider.searchSchemes('Health');
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Voice matched: "Health"')));
  }
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: const Icon(Icons.mic, color: AppColors.gold),
                          ),
                        )
                      ],
                    ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected = provider.currentCategoryFilter == cat;
                  ...
                  Expanded(
                    child: provider.isLoading
                      ...
                      : provider.filteredSchemes.isEmpty
                        ? Center(child: Text('No schemes found.', style: GoogleFonts.poppins(color: AppColors.textMuted)))
                        : ListView.builder(
                            padding: const EdgeInsets.all(24),
                            itemCount: provider.filteredSchemes.length,
                            itemBuilder: (context, index) {
                              final scheme = provider.filteredSchemes[index];
                              return Padding(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text(scheme.category, style: GoogleFonts.spaceMono(color: AppColors.accentBlue, fontSize: 12)),
                                          ),
                                ...
                                ).animate().slideX(begin: 0.1, end: 0, delay: Duration(milliseconds: 100 * (index % 5))),
                              );
                            },
                          ),
                  )
